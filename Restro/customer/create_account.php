                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h1 class="text-white">Ananda Food City POS System<br>Admin Login</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            <form method="post" role="form">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="create_account.php" class=" btn btn-success pull-right my-1" style="width: 350px;">Create Account</a>
                                    </div>
                                </div>
                            </form>
