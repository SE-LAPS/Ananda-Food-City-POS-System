...
<style>
    ...
    .custom-navbar {
      background-color: #2c2c2c; /* Dark black background color */
   ...
   <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light custom-navbar" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard.php">
        <img src="../admin/assets/img/brand/2.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="orders_reports.php"  style="color: #fff;">
              <i class="fas fa-shopping-basket yellow-icon"></i> My Orders
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="payments_reports.php"  style="color: #fff;">
              <i class="fas fa-funnel-dollar yellow-icon"></i> My Payments
            </a>
          </li>
        </ul>
        <hr class="my-3">
