...
<body>
  ...
  <div class="main-content">
    ...
    ?>
      <!-- Header -->
      <div style="background-image: url(assets/img/theme/1.png); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      ...
                      <input type="file" name="prod_img" class="btn btn-outline-warning form-control" value="<?php echo $prod_img; ?>">
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="UpdateProduct" value="Update Product" class="btn btn-warning" value="">
                  </div>
                  </div>
                </form>
              </div>
